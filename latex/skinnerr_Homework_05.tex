...
\\[-0.5cm]
\caption{FTCS solutions to \eqref{eq:prob1} compared to analytical solutions \eqref{eq:prob1_analytic}, and the point-wise relative error over time. Upper plots are for $d=0.5$ ($\Delta t = 0.033$), and lower plots correspond to $d=1.0$ ($\Delta t = 0.066$).}
\label{fig:Prob1}
\end{center}
\end{figure}
